...
def main():
    ...
    while not sair:
        ...
        if ret.colliderect(ret2) or ret.colliderect(ret4) or ret.colliderect(ret5) or ret.colliderect(
                bar1) or ret.colliderect(bar2) or ret.colliderect(square) or ret.colliderect(ret6) or ret.colliderect(
                ret7) or ret.colliderect(ret8) \
                or ret.colliderect(ret9) or ret.colliderect(ret10) or ret.colliderect(ret11) or ret.colliderect(
            ret12) or ret.colliderect(ret13) \
                or ret.colliderect(ret14) or ret.colliderect(ret15) or ret.colliderect(ret16) or ret.colliderect(
            ret17) or ret.colliderect(ret18) \
